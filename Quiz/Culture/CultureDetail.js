...
const CultureDetail = ({navigation, route}) => {
    ...
    useEffect(() => {
        const getWords = async () => {
            const docRef = doc(db, "Culture", wordid);
  ...
  return (
        <View style={{flex:1,height:height,width:width}}>
            ...
            <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('CulActivity', {wordid: wordid,day: day})}> 
